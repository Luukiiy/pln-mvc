...
<head>
	...
	<title>Tugas PBWL MVC</title>
	<link rel="shortcut icon" href="<?php echo AST; ?>/img/petir.png" type="image/x-icon">
...
<body>
	...
	<aside>
		...
		<header>
			<img src="<?php echo AST; ?>/img/colokan.png" class="brand">
			...
			<ul>
				...
				<li>
					<a href="<?php echo URL; ?>/pelanggan">
						<img class="icon" src="<?php echo AST; ?>/img/pelanggan3.png" alt=""> Pelanggan
					</a>
				</li>
				<li>
